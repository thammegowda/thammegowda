...
| BotEval
| Complete✅
| https://justin-cho.com/assets/boteval/boteval_acl2024.pdf[Paper^];  https://justin-cho.com/boteval[Demos^]
...
| Complete✅
| https://aclanthology.org/2023.wmt-1.62/[Paper @ WMT2023^]


| https://github.com/marian-nmt/sotastream[sotastream^]
| A streaming approach to machine translation training 
| Complete✅
| https://aclanthology.org/2023.nlposs-1.13/[Paper @ NLP OSS 2023^]
